...
int mosquitto_lib_init()
{
    lib = dlopen(libmosquitto_name.toStringz, RTLD_LAZY);
    mixin(rtLib);
}
...
mosquitto mosquitto_new(const(char)* id, bool clean_session, void* obj) { mixin(rtLib); }
void mosquitto_destroy(mosquitto mosq) { mixin(rtLib); }
int mosquitto_reinitialise(mosquitto mosq, const(char)* id, bool clean_session, void* obj) { mixin(rtLib); }
int mosquitto_will_set(mosquitto mosq, const(char)* topic, int payloadlen, const(void)* payload, int qos, bool retain) { mixin(rtLib); }
int mosquitto_will_clear(mosquitto mosq) { mixin(rtLib); }
int mosquitto_username_pw_set(mosquitto mosq, const(char)* username, const(char)* password) { mixin(rtLib); }
int mosquitto_connect(mosquitto mosq, const(char)* host, int port, int keepalive) { mixin(rtLib); }
int mosquitto_connect_bind(mosquitto mosq, const(char)* host, int port, int keepalive, const(char)* bind_address) { mixin(rtLib); }
int mosquitto_connect_async(mosquitto mosq, const(char)* host, int port, int keepalive) { mixin(rtLib); }
int mosquitto_connect_bind_async(mosquitto mosq, const(char)* host, int port, int keepalive, const(char)* bind_address) { mixin(rtLib); }
int mosquitto_connect_srv(mosquitto mosq, const(char)* host, int keepalive, const(char)* bind_address) { mixin(rtLib); }
int mosquitto_reconnect(mosquitto mosq) { mixin(rtLib); }
int mosquitto_reconnect_async(mosquitto mosq) { mixin(rtLib); }
int mosquitto_disconnect(mosquitto mosq) { mixin(rtLib); }
int mosquitto_publish(mosquitto mosq, int* mid, const(char)* topic, int payloadlen, const(void)* payload, int qos, bool retain) { mixin(rtLib); }
int mosquitto_subscribe(mosquitto mosq, int* mid, const(char)* sub, int qos) { mixin(rtLib); }
int mosquitto_unsubscribe(mosquitto mosq, int* mid, const(char)* sub) { mixin(rtLib); }
...
int mosquitto_loop(mosquitto mosq, int timeout, int max_packets) { mixin(rtLib); }
int mosquitto_loop_forever(mosquitto mosq, int timeout, int max_packets) { mixin(rtLib); }
int mosquitto_loop_start(mosquitto mosq) { mixin(rtLib); }
int mosquitto_loop_stop(mosquitto mosq, bool force) { mixin(rtLib); }
int mosquitto_socket(mosquitto mosq) { mixin(rtLib); }
int mosquitto_loop_read(mosquitto mosq, int max_packets) { mixin(rtLib); }
int mosquitto_loop_write(mosquitto mosq, int max_packets) { mixin(rtLib); }
int mosquitto_loop_misc(mosquitto mosq) { mixin(rtLib); }
bool mosquitto_want_write(mosquitto mosq) { mixin(rtLib); }
int mosquitto_threaded_set(mosquitto mosq, bool threaded) { mixin(rtLib); }
int mosquitto_opts_set(mosquitto mosq, MOSQ_OPT option, void* value) { mixin(rtLib); }
...
int mosquitto_tls_insecure_set(mosquitto mosq, bool value) { mixin(rtLib); }
int mosquitto_tls_opts_set(mosquitto mosq, int cert_reqs, const(char)* tls_version, const(char)* ciphers) { mixin(rtLib); }
int mosquitto_tls_psk_set(mosquitto mosq, const(char)* psk, const(char)* identity,  const(char)* ciphers) { mixin(rtLib); }

alias mosq_base_callback = extern(C) void function(mosquitto, void*, int);
alias mosq_msg_callback = extern(C) void function(mosquitto, void*, const mosquitto_message*);
alias mosq_sub_callback = extern(C) void function(mosquitto, void*, int, int, const int*);
alias mosq_log_callback = extern(C) void function(mosquitto, void*, int, const(char)*);
void mosquitto_connect_callback_set(mosquitto mosq, mosq_base_callback on_connect) { mixin(rtLib); }
void mosquitto_disconnect_callback_set(mosquitto mosq, mosq_base_callback on_disconnect) { mixin(rtLib); }
void mosquitto_publish_callback_set(mosquitto mosq, mosq_base_callback on_publish) { mixin(rtLib); }
void mosquitto_message_callback_set(mosquitto mosq, mosq_msg_callback on_message) { mixin(rtLib); }
void mosquitto_subscribe_callback_set(mosquitto mosq, mosq_sub_callback on_subscribe) { mixin(rtLib); }
void mosquitto_unsubscribe_callback_set(mosquitto mosq, mosq_base_callback on_unsubscribe) { mixin(rtLib); }
void mosquitto_log_callback_set(mosquitto mosq, mosq_log_callback on_log) { mixin(rtLib); }
int mosquitto_reconnect_delay_set(mosquitto mosq, uint reconnect_delay, uint reconnect_delay_max,
                                    bool reconnect_exponential_backoff) { mixin(rtLib); }
int mosquitto_max_inflight_messages_set(mosquitto mosq, uint max_inflight_messages) { mixin(rtLib); }
void mosquitto_message_retry_set(mosquitto mosq, uint message_retry) { mixin(rtLib); }
void mosquitto_user_data_set(mosquitto mosq, void* obj) { mixin(rtLib); }

int mosquitto_socks5_set(mosquitto mosq, const(char)* host, int port, const(char)* username, const(char)* password) { mixin(rtLib); }
